...
export default class SearchBar extends Component {
  ...
  render() {
    ...
    const svg = (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" link="http://www.w3.org/1999/xlink">
    ...
    return (
      <div className="custom-searchbar">
        {svg}
        <input onChange={this.handleSearch} placeholder="Search..." type="text" />
      </div>
    );
  }
}
